export default [
  ...
  { date: new Date(2018, 9), label: "SDE II", tooltip: "Tesco PLC" },
  {
  ...
  { date: new Date(2016, 7), label: "Technology Intern", tooltip: "Tesco PLC" },
  {
    date: new Date(2015, 7),
    label: "Engineering Intern",
    tooltip: "BT Global Engineering Services",
  },
  {
