...
const roles = [
  ...
  { date: new Date(2017, 9), label: "Graduate Software Engineer" },
  { date: new Date(2017, 7), label: "Computer Science Graduate" },
  { date: new Date(2016, 7), label: "Technology Intern" },
  { date: new Date(2015, 7), label: "Engineering Intern" },
